...
module.exports.run = async (client, message, args) => {
  ...
  if (sayMessage == '7 seeds') {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setDescription(`O protagonista acorda sem lembranças em um local desconhecido e conhece algumas meninas. Ele então se aproxima delas para descobrir um mistério oculto.`)
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .setDescription(`Rikuo Uozumi se resignou a um futuro sombrio, trabalhando sem rumo em uma loja de conveniência em Tóquio depois de se formar na faculdade. Sua vida monótona é interrompida quando o peculiar Haru Nonaka faz uma aparição animada, frequentemente aparecendo em seu local de trabalho para fazer amizade com ele. Quando Rikuo descobre que um velho amigo da faculdade e paixão, Shinako Morinome, voltou para a cidade, ele estende a mão para promover o relacionamento deles. Sem o conhecimento de Rikuo, Shinako está carregando lembranças dolorosas de seu passado que a impediam de aceitar seus sentimentos. Enquanto isso, enquanto Haru se abre para Rikuo, ele descobre que ela, assim como ele, está vivendo sozinha e quer sair de sua zona de conforto em um futuro incerto. O passado permanece muito tempo na mente e o futuro permanece ilusório. Numa encruzilhada ao longo de seus caminhos entrelaçados, esses três experimentam o que significa abandonar seus sentimentos de ontem e abraçar a mudança que o amanhã traz.`)
